...
const cards: IFAQCard[] = [
    {
        title: 'Hvem kan jeg stemme på?',
        picture: '/images/vote.png',
    },
    {
        title: 'Er min stemme anonym?',
        picture: '/images/spy.png',
    },
    {
        title: 'Hvornår er næste valg?',
        picture: '/images/box.png',
    },
    {
        title: 'Har jeg stemmeret?',
